 ...
 */
final class Version20230307095225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE default_company (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE owner_information (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', default_company_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', name VARCHAR(255) DEFAULT NULL, gender VARCHAR(255) DEFAULT NULL, account_type VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_2F9DC705DFB84EB5 (default_company_id), INDEX index_id (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
